import { createCssVariableStyle } from "@learn-chinese-ai/design-tokens";
...
// Expose design tokens during SSR so shared UI styles work before hydration.
const designTokenStyle = createCssVariableStyle() as CSSProperties;
...
export default function RootLayout({
  ...
  return (
    <html lang="en" style={designTokenStyle}>
      <body>
        <AuthProvider>
          <div>
